# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-10-22 20:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('samst', models.IntegerField(blank=True)),
                ('samend', models.IntegerField(blank=True)),
                ('solvent', models.CharField(max_length=100)),
                ('mass', models.FloatField()),
                ('volume', models.FloatField()),
                ('conc', models.FloatField()),
                ('testconc', models.FloatField(blank=True)),
